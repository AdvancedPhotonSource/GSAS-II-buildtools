...
echo python $PREFIX/gitcompile.py --nocheck --noshortcut --noprogress --log=/tmp/gitcompile.log --branch=main >> $logfile 2>&1
     python $PREFIX/gitcompile.py --nocheck --noshortcut --noprogress --log=/tmp/gitcompile.log --branch=main >> $logfile 2>&1
